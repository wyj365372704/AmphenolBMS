...
public class ProductionReportActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportFragmentManager().beginTransaction().replace(R.id.activity_purchase_receipt_fl, mProductionReportJobListFragment,mProductionReportJobListFragment.getClass().getName()).commitAllowingStateLoss();
    }
}
