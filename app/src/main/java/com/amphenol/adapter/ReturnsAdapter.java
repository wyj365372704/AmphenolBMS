 ...
 */
public class ReturnsAdapter extends RecyclerView.Adapter {
    private List<Returns.ReturnsItem> date;
    private OnItemClickListener onItemClickListener;
    private Context mContext;

    public void setDate(List<Returns.ReturnsItem> date) {
        this.date = date;
    }

    public ReturnsAdapter(Context mContext, List<Returns.ReturnsItem> date, OnItemClickListener onItemClickListener) {
        this.date = date;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ViewHolderBody(LayoutInflater.from(mContext).inflate(R.layout.pruchase_return_main_item_body, parent, false));
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        ((ViewHolderBody) holder).slTextView.setText(date.get(position).getQuantity() + "");
